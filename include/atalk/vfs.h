...
#define VFS_FUNC_ARGS_EA_GETCONTENT                                            \
  const struct vol *restrict vol, char *restrict rbuf,                         \
      size_t *restrict rbuflen, const char *restrict uname, int oflag,         \
      const char *restrict attruname, int maxreply
#define VFS_FUNC_VARS_EA_GETCONTENT                                            \
  vol, rbuf, rbuflen, uname, oflag, attruname, maxreply

#define VFS_FUNC_ARGS_EA_LIST                                                  \
  const struct vol *restrict vol, char *restrict attrnamebuf,                  \
      size_t *restrict buflen, const char *restrict uname, int oflag
