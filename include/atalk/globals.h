...
#define OPTION_KEEPSESSIONS                                                    \
  (1 << 10) /* preserve sessions across master afpd restart with SIGQUIT */
...
extern void afp_options_free(struct afp_options *, const struct afp_options *);
