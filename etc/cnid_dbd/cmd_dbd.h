...
#define DBD_FLAGS_CLEANUP                                                      \
  (1 << 3) /* Dont create AD stuff, but cleanup orphaned */
...
extern int cmd_dbd_scanvol(DBD *dbd, struct volinfo *volinfo,
                           dbd_flags_t flags);
...
*/
extern int cmd_dbd_add(DBD *dbd, struct cnid_dbd_rqst *rqst,
