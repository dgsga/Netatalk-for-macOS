...
static int dhx2_setup(void *obj, char *ibuf _U_, size_t ibuflen _U_, char *rbuf,
                      size_t *rbuflen) {
  int ret;
  size_t nwritten;
  gcry_mpi_t Ma;
...
static int logincont2(void *obj_in, struct passwd **uam_pwd, char *ibuf,
                      size_t ibuflen, char *rbuf _U_, size_t *rbuflen) {
  AFPObj *obj = obj_in;
  int ret = AFPERR_MISC;
  int PAM_error;
...
static int changepw_3(void *obj _U_, char *ibuf, size_t ibuflen _U_,
...
static int dhx2_changepw(void *obj _U_, char *uname, struct passwd *pwd _U_,
                         char *ibuf, size_t ibuflen _U_, char *rbuf _U_,
                         size_t *rbuflen _U_) {
