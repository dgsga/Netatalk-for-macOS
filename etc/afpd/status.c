...
void set_signature(struct afp_options *options) {
    ...
    if (strcmp(options->signatureopt, "auto") == 0) {
        ...
        LOG(log_warning, logtype_afpd, "WARNING: option \"-signature host\" is obsoleted. Switching back to auto.",
        ...
        LOG(log_error, logtype_afpd, "ERROR: option \"-signature %s\" is not valid. Switching back to auto.",
            options->signatureopt);
    ...
    if (len <= 5) {
        LOG(log_warning, logtype_afpd, "WARNING: option \"-signature %s\" is not valid. Switching back to auto.",
            options->signatureopt);
