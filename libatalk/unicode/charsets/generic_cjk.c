...
size_t cjk_generic_push(size_t (*char_func)(u_int8_t *, const ucs2_t *,
                                            size_t *),
...
size_t cjk_generic_pull(size_t (*char_func)(ucs2_t *, const u_int8_t *,
                                            size_t *),
                        void *cd, char **inbuf, size_t *inbytesleft,
                        char **outbuf, size_t *outbytesleft) {
  char *in = *inbuf;
...
ucs2_t cjk_compose_seq(const ucs2_t *in, size_t *len, const u_int32_t *table,
                       size_t size) {
