...
static struct server_child_data *resolve_child(struct server_child_data **table,
                                               pid_t pid) {
  struct server_child_data *child;
 ...
 */
afp_child_t *server_child_add(server_child *children, int forkid, pid_t pid,
                              int ipc_fd) {
 ...
 */
int server_child_transfer_session(server_child *children, int forkid, pid_t pid,
  ...
  LOG(log_note, logtype_default, "Reconnect: transfering session to child[%u]",
      pid);
...
void server_child_kill_one_by_id(server_child *children, int forkid, pid_t pid,
                                 uid_t uid, uint32_t idlen, char *id,
                                 uint32_t boottime) {
  server_child_fork *fork;
  struct server_child_data *child, *tmp;
  int i;
