...
cnid_t cnid_last_add(struct _cnid_db *cdb, const struct stat *st,
                     const cnid_t did _U_, const char *name _U_, const size_t len _U_,
                     cnid_t hint _U_) {
...
cnid_t cnid_last_lookup(struct _cnid_db *cdb _U_, const struct stat *st _U_,
                        const cnid_t did _U_, char *name _U_,
                        const size_t len _U_) {
...
static struct _cnid_db *cnid_last_new(const char *volpath) {
  ...
  cdb->cnid_add =
      (cnid_t(*)(struct _cnid_db *, const struct stat *, const cnid_t,
                 const char *, const size_t, cnid_t))cnid_last_add;
